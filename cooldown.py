...
# Parameters
R = 0.014  # Radius of the inner water core (m)
...
# 1. Use initial temperature of the paragon ball. Uncomment bloc depending on use case.
# initial_temp = np.concatenate([np.full_like(r_w, T_initial), 
#                                  np.full_like(r_s, T_initial), 
#                                  np.full_like(r_air, T_air)])

# 2. Use pre-existing temperature profile for back-to-back simulation
...
# Save temperature as npy array for later use
